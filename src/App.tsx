...
import cvFile from "./assets/CV-2025.pdf";
...
function App() {
  ...
  const EXPERIENCES: Experience[] = [
    {
      ...
      content:
        "Managed complex enterprise systems with five branches, integrating inventory, employee management, data processing, and POS operations. Developed and maintained an in-house PHP framework, integrated AI with Ollama LLMs for automation, and independently built a SaaS-based PMS website with payment gateway integration.",
    },
    {
      id: "e2",
      ...
      content:
        "Developed websites and mobile applications directly for clients. Implemented new features for a React Native mobile app (Expo), integrated backend APIs, and ensured seamless functionality across Android and iOS platforms.",
    },
    {
      id: "e3",
      ...
      content:
        "Led development of two simultaneous projects: a Laravel Barangay Information System and a Multi-Tenanted Business Management web application using Laravel and Angular. Mentored junior developers and conducted code reviews.",
    },
    {
      id: "e4",
      ...
      content:
        "Gained hands-on experience in full-stack development, deployed websites on AWS (EC2, S3, SSL), developed social media and internal recruitment platforms, integrated UX/UI designs, and maintained live websites with hundreds of users.",
    },
  ];
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M7 16h10M7 8h10M5 12h14M12 20v-8"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 8v4l3 3M12 20c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8z"
          />
        </svg>
      ),
    },
  ...
  useEffect(() => {
    ...
    const moveNext = async () => {
      ...
      currentIndex++;
      const currentMargin =
        (currentIndex / loopTestimonials.length) * 100 + 0.3;
  ...
  const computeProjects = (tabId: string) => {
    return tabId === "all"
      ? PROJECTS
      : PROJECTS.filter((p) => p.category === tabId);
  };
    ...
    <div className={`${darkMode ? "dark" : ""}`}>
      <div className="font-sans text-gray-800 dark:text-gray-100 bg-gray-50 dark:bg-neutral-800 transition-colors duration-300">
        ...
        <main className="scroll-smooth">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-10">
                {ProjectsTabs.map((tab) => (
                  <button
                    ...
                    className={`px-4 py-2 text-md font-light transition rounded-full ${
                      activeTab === tab.id
          ...
          <section
            id="resume"
            className="min-h-screen flex items-center px-6  bg-gray-50 dark:bg-neutral-900"
          >
            <div className="max-w-3xl mx-auto w-full text-center">
              <h2 className="text-3xl font-normal mb-10">
                My <b className="font-extrabold">Resume</b>
              </h2>
          ...
          <section id="about" className="w-full flex flex-col">
              ...
              <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center  py-16 ">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                    I’m a developer passionate about creating impactful
                    experiences on the web. I believe in simplicity,
                    performance, and beautiful design. This portfolio reflects
                    today’s minimalist design trends with light/dark themes and
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <a
                      href={cvFile} // 👈 place your CV in /public/cv.pdf
                      download
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  {services.map((service, idx) => (
                    ...
                    >
                      ...
                      <h4 className="text-xl font-semibold text-emerald-500 mb-2">
                        {service.title}
                      </h4>
            ...
            <div
              id="testimonials"
              className="min-h-screen flex flex-col py-20 items-center w-full bg-gray-50 dark:bg-neutral-900"
            >
                ...
                <div className="relative">
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      className="bg-white dark:bg-neutral-800 shadow-lg rounded-2xl px-8 py-10"
                    >
          ...
          <section
            id="contact"
            className="pb-40 flex items-center justify-center px-6 bg-gray-50 dark:bg-neutral-900"
          >
            <div className="max-w-4xl w-full grid md:grid-cols-2 gap-12 items-center">
              {/* Left Side - Contact Details & Socials */}
              <div className="space-y-6">
                <h2 className="text-3xl font-normal mb-4">
                  Get <b className="font-extrabold">in Touch</b>
                </h2>
                <p className="text-gray-700 dark:text-gray-300">
                  Interested in working together? Drop me a message or connect
                  through social media. I’d love to hear from you!
                </p>
                ...
                <div className="space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <p>
                    <strong>Phone:</strong> +63 900 123 4567
                  </p>
                  <p>
                ...
                <div className="flex space-x-4 mt-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    className="text-gray-600 dark:text-gray-300 hover:text-emerald-400"
                  >
